...
var proto_rippleapi_account_pb = require('../../proto/rippleapi/account_pb.js');

function serialize_rippleapi_account_RequestGetAccountInfo(arg) {
  if (!(arg instanceof proto_rippleapi_account_pb.RequestGetAccountInfo)) {
...
function deserialize_rippleapi_account_RequestGetAccountInfo(buffer_arg) {
  return proto_rippleapi_account_pb.RequestGetAccountInfo.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_rippleapi_account_ResponseGetAccountInfo(arg) {
  if (!(arg instanceof proto_rippleapi_account_pb.ResponseGetAccountInfo)) {
...
function deserialize_rippleapi_account_ResponseGetAccountInfo(buffer_arg) {
  return proto_rippleapi_account_pb.ResponseGetAccountInfo.deserializeBinary(new Uint8Array(buffer_arg));
}
...
getAccountInfo: {
    ...
    requestType: proto_rippleapi_account_pb.RequestGetAccountInfo,
    responseType: proto_rippleapi_account_pb.ResponseGetAccountInfo,
