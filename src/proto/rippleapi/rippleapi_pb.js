...
proto.rippleapi.ResponseSubmitTransaction.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    latestledgerversion: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
...
proto.rippleapi.ResponseSubmitTransaction.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      var value = /** @type {number} */ (reader.readUint32());
      msg.setLatestledgerversion(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.rippleapi.ResponseSubmitTransaction.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getLatestledgerversion();
  if (f !== 0) {
    writer.writeUint32(
      2,
      f
...
/**
 * optional uint32 latestLedgerVersion = 2;
 * @return {number}
 */
proto.rippleapi.ResponseSubmitTransaction.prototype.getLatestledgerversion = function() {
 ...
 * @return {!proto.rippleapi.ResponseSubmitTransaction} returns this
 */
proto.rippleapi.ResponseSubmitTransaction.prototype.setLatestledgerversion = function(value) {
